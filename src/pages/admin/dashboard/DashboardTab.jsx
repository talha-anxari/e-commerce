...
//             <button
//               type="button"
//               className={`flex items-center gap-2 px-6 py-2 text-lg font-medium rounded-md transition ${
//                 mode === 'dark'
...
//             <h1 className="text-2xl font-semibold text-center mb-4">Product Details</h1>
...
//               <table className="min-w-full bg-gray-50 text-gray-800 rounded-md overflow-hidden">
...
//                       <img className="w-16 rounded-md" src="https://dummyimage.com/720x400" alt="img" />
//                     </td>
//                     <td className="px-6 py-4">Title</td>
//                     <td className="px-6 py-4">PKR 100</td>
...
//                     <td className="px-6 py-4">282</td>
//                     <td className="px-6 py-4">939392292929</td>
//                     <td className="px-6 py-4">kakk@gmail.com</td>
//                     <td className="px-6 py-4">12 Aug 2019</td>
//                   </tr>
//                 </tbody>
//               </table>
                ...
                <div className="relative overflow-x-auto ">
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                    ...
                    {product.map((item, index) => {
                      const {title, price, imgUrl, category, kg, date, } = item;
                      return (
